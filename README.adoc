...
image::/img/guide/guide-overview-architecture.png[link="/img/guide/guide-overview-architecture.png" alt="Main Kabanero building blocks"]
...
.Collection stacks
image::/img/guide/guide-overview-stacks.png[link="/img/guide/guide-overview-stacks.png" alt="Collection stacks"]
...
image::/img/guide/guide-overview-workflows.png[link="/img/guide/guide-overview-workflows.png" alt="Application Developer and Application Architect workflows"]
