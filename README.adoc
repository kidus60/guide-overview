...
---
This concludes the overview of the Kabanero architecture. Head back to the https://kabanero.io[Kabanero.io website] for deeper dives into Kabanero component and "Getting Started" guides that will get you up and running with hands-on examples of the workflows introduced here.