...
image::/img/guide/architecture.png[link="/img/guide/architecture.png" alt="Main Kabanero building blocks"]
...
.Collection stacks
image::/img/guide/architecture-flow.png[link="/img/guide/architecture-flow.png" alt="Collection stacks"]
...
image::/img/guide/jane_tekton_webhook_pic.png[link="/img/guide/jane_tekton_webhook_pic.png" alt="Application Developer and Application Architect workflows"]
